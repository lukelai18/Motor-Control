...
// This function will be responsible for starting the motor
//void MotorControl(uint8_t direction, uint16_t speed)
//{
//    // Set the motor direction pin
//    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_10, direction);
//
//    // Set the motor speed by configuring the PWM timer
//    // You would need to write code to configure and start the timer with the given speed
//
//    // Example:
//    // TIM2->ARR = 65535 / speed;  // Calculate ARR value based on speed
//    // TIM2->CCR4 = TIM2->ARR / 2; // 50% duty cycle
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  HAL_Delay(100);
	// myprintf("The first limit is %d %d\n\r", limit1State, limit2State);
